@extends('layout')
@section('title')
    <h1 class="text-4xl font-bold text-center">Découvrez notre circuit <span class="text-primary">Aventure MX Park</span></h1>
@endsection
@section('content')
    <div class="flex flex-col w-full gap-4 max-w-7xl">
        @foreach ($circuits as $circuit)
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="flex flex-col w-full col-span-2 gap-4 p-2 text-xl rounded-md">
                    <p class="text-xl">
